...
public class Texture {//get textures 
	...
	//public BufferedImage[] main_bg = new BufferedImage[1];//main menu background
	public BufferedImage[] exitDoor = new BufferedImage[1];//exit door
	public BufferedImage[] level = new BufferedImage[10];//level maps
	
	public Texture(){
		
		BufferedImageLoader loader = new BufferedImageLoader();//put all image paths here
		try{
			...
			//main_sheet = loader.loadImage("/menuv3.png");
	...
	private void getTextures(){//get all textures files here
		...
		//main_bg[0] = ms.grabImage(1, 1, 800, 600);
