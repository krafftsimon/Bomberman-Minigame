/**
 * HowToPlay class for graphical images on options submenu
 */
...
import java.awt.Stroke;
	...
	public class HowToPlay {
		...
		public Rectangle pauseBox = new Rectangle(x,y+6*height,width,height);
		public Rectangle pauseBox2 = new Rectangle(x+width,y+6*height,width,height);
		
		public Rectangle backButton = new Rectangle(650,540,120,40);
	
		//public Rectangle muteButton = new Rectangle(450,300,70,70);
		
	/**
	 * Rendering method for HowToPlay 	
	...
	public void render(Graphics g){
			...
			g.fillRect(x, y, width*2, height*7);//filling for controls
			g.fillRect(650, 540, 120, 40);//filling for back button
			g.fillRect(450,270, 70, 100);
			...
			g.drawString("Pause", pauseBox.x+x, pauseBox.y+y);
			...
			g.drawString("p", pauseBox2.x+x,pauseBox2.y+y);
			//g.drawString("MUTE", muteButton.x+5, muteButton.y-10);
