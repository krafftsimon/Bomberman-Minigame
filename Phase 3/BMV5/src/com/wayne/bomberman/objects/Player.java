/**
 * Player class for the player. It has all its attributes, bounds and graphical images
 */
...
public class Player extends GameObject {
	 ...
	 * has its collision, velocity and walking animations
	 */
	...
	public void render(Graphics g) {
		...
		/**
		 * This method creates rectangles for the player bounderies	
		 */
		...
		/**
		 * this method checks if player has reached exit position
