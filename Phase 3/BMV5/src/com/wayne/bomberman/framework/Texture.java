/**
 * Texture Class for drawing all images
 */
...
public class Texture {
	...
	/**
	 * get all textures files here and put them  in the right BufferedImage
	 */
	private void getTextures(){
		...
		enemy[0] = es.grabImage(9,15,32,32);//Mushroom
		enemy[1] = es.grabImage(1,1,32,32);//Holycow
		enemy[2] = es.grabImage(2,1,32,32);//metal tarantula
	}
}
